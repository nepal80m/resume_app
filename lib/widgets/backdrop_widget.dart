...
class BackdropWidget extends StatelessWidget {
  ...
  BackdropWidget(
      {Key key, @required this.contentList, @required this.resumeContent})
      : super(key: key);
      ...
      list.add(
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: (this.contentList.indexOf(this.resumeContent) == i)
                ? this.resumeContent.viewColor
                : null,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      this.resumeContent.beginGradient,
                      this.resumeContent.endGradient
                    ],
